...
const Develop = () => {
  return (
    <div
      className="z-0 flex items-center justify-start min-h-screen bg-top bg-no-repeat bg-cover -mt-[57px] bg-no-repea "
    ...
    >
      <div className="w-full text-black ">
        <div className="max-w-[1053px] mx-auto">
          ...
          <h1 className="text-[78px] leading-[126px] font-bold text-center py-12 ">
            I’ve been{" "}
